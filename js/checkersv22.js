...
{ 
    ...
    {
        console.log("inHarmsWay is operating on a potential move..." + document.getElementsByClassName("Selected")[0].id + " to " + check.id);
    ...
    console.log("Checking out " + check.id + " versus [" + (Xval+Xjump) + "][" + (Yval+Yjump) + "]");
    ...
    {
        console.log("Move at " + check.id + " can be attacked by [" + (Xval+Xjump) + "][" + (Yval+Yjump) + "]");
        
        // This opponent is on an edge, flag it as being dangerous
        if((Xval+Xjump) == 0 || (Xval+Xjump) == 7 || (Yval+Yjump) == 0 || (Yval+Yjump) == 7)
        {
                return true;
        }
        
        // If the space behind this piece is NOT empty
        if(document.getElementById("[" + (Xval + (Xjump * 2) ) + "][" + (Yval + (Yjump * 2) ) + "]").classList.contains(opp) || document.getElementById("[" + (Xval + (Xjump * 2) ) + "][" + (Yval + (Yjump * 2) ) + "]").classList.contains(color))
        {
            return true;
        }

    } // End of potential threat
